...
2. **Dashboard**: After logging in, users are taken to their dashboard. The dashboard could have the following sections:
...
3. **Content Generation Page**: On this page, users can enter keywords, a title, and a length to generate new content. They can also use voice to text to dictate their content. Once the content is generated, it is displayed on the page. Users can then choose to save it, edit it, copy it, or export it in various formats (MD, DOCX, TXT). They can also publish it directly to various platforms (Medium, Hashnode, LinkedIn).

4. **Profile Settings Page**: On this page, users can manage their account and personal details. This might include changing their password, updating their email address, managing their subscription, etc.

5. **Upgrade Page**: On this page, users can upgrade their account for additional features. This might involve choosing a subscription plan, entering payment details, etc.

For the dashboard layout, here's a textual description:
